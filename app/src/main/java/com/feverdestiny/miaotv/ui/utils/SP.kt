package com.feverdestiny.miaotv.ui.utils
...
object SP {
    ...
    enum class KEY {
        ...
        /** Logcat 输出播放链路诊断（MiaoTvPlayback） */
    ...
    /** 直播源频道收藏列表（旧版）；迁移逻辑见 [com.feverdestiny.miaotv.data.IptvFavoriteMigration] */
    ...
    /** Logcat 标签 `MiaoTvPlayback`：起播/重试/传输切换等摘要（不含完整 URL） */
