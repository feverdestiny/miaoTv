package com.feverdestiny.miaotv.ui.screens.leanback.update
...
import com.feverdestiny.miaotv.data.repositories.git.GitRepository
...
import com.feverdestiny.miaotv.utils.Downloader
...
class LeanBackUpdateViewModel : ViewModel() {
    ...
    /**
     * 从 [Constants.GIT_RELEASE_LATEST_URL] 拉取最新 Release（列表 API，含 prerelease；
     * 获取层按 gh-proxy → 官方 API 回退），与当前安装版本比较。
