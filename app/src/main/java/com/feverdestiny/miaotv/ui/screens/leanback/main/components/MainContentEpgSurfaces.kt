...
import com.feverdestiny.miaotv.data.entities.Epg
import com.feverdestiny.miaotv.data.entities.EpgList
import com.feverdestiny.miaotv.data.entities.EpgList.Companion.currentProgrammes
...
import com.feverdestiny.miaotv.ui.screens.leanback.classicpanel.LeanbackClassicPanelScreen
import com.feverdestiny.miaotv.ui.screens.leanback.components.LeanbackVisible
import com.feverdestiny.miaotv.ui.screens.leanback.panel.LeanbackPanelTempScreen
import com.feverdestiny.miaotv.ui.screens.leanback.quickpanel.LeanbackQuickPanelScreen
    ...
    LeanbackVisible({ mainContentState.isQuickPanelVisible && !mainContentState.isSettingsVisible }) {
        LeanbackQuickPanelScreen(
            ...
            audioTracksProvider = {
                ...
                videoPlayerState.getTrackOptions(com.feverdestiny.miaotv.ui.screens.leanback.video.player.LeanbackVideoPlayer.TrackType.Audio)
            },
            videoTracksProvider = {
                videoPlayerState.trackSelectionVersion
                videoPlayerState.getTrackOptions(com.feverdestiny.miaotv.ui.screens.leanback.video.player.LeanbackVideoPlayer.TrackType.Video)
            },
            subtitleTracksProvider = {
                videoPlayerState.trackSelectionVersion
                videoPlayerState.getTrackOptions(com.feverdestiny.miaotv.ui.screens.leanback.video.player.LeanbackVideoPlayer.TrackType.Subtitle)
            },
            onSelectAudioTrack = {
                videoPlayerState.selectTrack(
                    com.feverdestiny.miaotv.ui.screens.leanback.video.player.LeanbackVideoPlayer.TrackType.Audio,
                    it,
                )
            },
            onSelectVideoTrack = {
                videoPlayerState.selectTrack(
                    com.feverdestiny.miaotv.ui.screens.leanback.video.player.LeanbackVideoPlayer.TrackType.Video,
                    it,
                )
            },
            onSelectSubtitleTrack = {
                videoPlayerState.selectTrack(
                    com.feverdestiny.miaotv.ui.screens.leanback.video.player.LeanbackVideoPlayer.TrackType.Subtitle,
                    it,
                )
            },
