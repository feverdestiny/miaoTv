package com.feverdestiny.miaotv.receivers
...
import com.feverdestiny.miaotv.ui.screens.leanback.toast.LeanbackToastProperty
import com.feverdestiny.miaotv.ui.screens.leanback.toast.LeanbackToastState
import com.feverdestiny.miaotv.ui.utils.InstallFallbackNotifier
import com.feverdestiny.miaotv.utils.ApkInstaller
import java.io.File
    ...
    private fun buildFailureMessage(status: Int, legacy: Int, systemMsg: String?): String {
        ...
        if (sm.contains("NO_MATCHING", ignoreCase = true) ||
            ...
            return "安装包与当前设备 CPU 架构不匹配（常见原因：x86 设备下载了仅含 ARM 的 APK）。" +
                "请使用 GitHub Release 中的 miaotv-*-x86_64.apk，或确认自动更新已选到对应架构附件。"
        }
