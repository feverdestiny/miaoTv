...
import com.feverdestiny.miaotv.defaults.AppBuiltinEndpoints
...
object Constants {
     ...
     * 存储为空时生效；默认无自定义 UA。
     */
    val EPG_XML_URL: String get() = AppBuiltinEndpoints.EPG_XML_PRIMARY

    /** 内置 APTV 节目单；未单独配置 UA 时拉取使用 User-Agent: aptv */
    val EPG_XML_URL_APTV: String get() = AppBuiltinEndpoints.EPG_XML_SECONDARY
