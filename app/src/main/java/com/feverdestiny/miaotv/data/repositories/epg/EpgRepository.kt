package com.feverdestiny.miaotv.data.repositories.epg
...
import com.feverdestiny.miaotv.data.repositories.epg.fetcher.EpgFetcher
...
class EpgRepository : FileCacheRepository("epg.json") {
     ...
     * 是否拉网、钟点限制由调用方（如 [com.feverdestiny.miaotv.data.work.EpgRefreshWorker]）控制。
     */
